...
class EvaluateTotalGenerator:
    ...
    def __init__(self, llm) -> None:
        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                ("system", CustomPrompt.GENERATE_EVALUATE_TOTAL_PROMPT),
                ("human", "Dưới đây là dữ liệu JSON đã được trích xuất từ phản hồi của người dùng về một thương hiệu: {question}")
            ]
        )
