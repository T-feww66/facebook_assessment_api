...
class EvaluateCompareGenerator:
    """
    ...
    def __init__(self, llm) -> None:
        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                ("system", CustomPrompt.GENERATE_EVALUATE_COMPARE_PROMPT),
                ("human", "{question} \n Vui lòng phân tích ưu nhược điểm, sự khác biệt và đưa ra kết luận khách quan.")
            ]
        )
